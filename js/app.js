...
var AI_KB = {
  ...
  industries: {
    ...
    '企业服务': { price: '+¥3,000~8,800', features: 'AI智能客服搭建+自动化工作流+在线预约+服务评价', base: '推荐 B1品牌版 ¥12,800 + 增值服务按需叠加' },
  ...
  faq: {
    ...
    '多久上线': '网站：A1体验版3天 / A2初创版7天 / B1品牌版12天 / B2专业版18天 / C1集团版25天。小程序另加微信审核7-14天（不计入工期）。以上均不含客户反馈时间。注意：网站如需ICP备案（使用国内服务器），备案周期约20个工作日，期间可同步进行内容准备。',
    ...
    '案例': '有的！我们已服务多家客户，涵盖酒店民宿、餐饮、零售、企业服务等多个行业。可以针对您的行业发相关案例给您参考。',
...
function matchKB(msg) {
  ...
  if (/自动.*工作流|工作流.*搭建|n8n|自动化.*流程|自动化.*办公/.test(m)) {
    return '<b>⚡ 全自动化工作流搭建</b><br><br>基于 n8n / Make 等平台，为企业搭建自动化业务流程。<br><br>📋 <b>服务内容：</b><br>· 业务流程调研 + 自动化方案设计<br>· n8n / Make 工作流搭建与部署<br>· 飞书/钉钉/企微通知集成<br>· 数据库 + API 对接<br><br>💰 <b>定价：¥3,800 起</b>（按流程复杂度评估）<br><br>📌 <b>适用场景：</b><br>· 表单自动录入 + 通知<br>· 订单自动处理 + 物流提醒<br>· 客户跟进自动提醒<br>· 周报/月报自动生成<br><br>👉 告诉我你目前的业务流程，我帮你评估自动化方案～';
  }
  if (/AI.*客服.*搭建|搭建.*AI.*客服|AI.*客服.*价格|AI.*客服.*多少钱|智能客服.*搭建/.test(m)) {
    return '<b>🤖 AI 客服搭建服务</b><br><br>为你的网站、小程序、公众号接入智能客服，24/7 自动应答。<br><br>📋 <b>服务内容：</b><br>· 知识库定制训练（50条~无限问答）<br>· 多轮对话引擎 · 上下文记忆<br>· 网页/小程序/公众号多端嵌入<br>· 对话数据分析面板<br><br>💰 <b>定价：</b><br>· 基础版：<b style="color:var(--terracotta);">免费</b>（随B1及以上网站套餐赠送）<br>· 标准版：<b style="color:var(--terracotta);">¥2,800</b>（200条问答+行业知识库）<br>· 企业版：<b style="color:var(--terracotta);">¥5,800</b>（无限问答+API对接+私有化训练）<br><br>👉 想了解哪个版本？也可以直接告诉我要搭建的网站/小程序类型，我帮你推荐～';
  }
  if (/企业服务/.test(m)) {
    return '<b>🏢 企业数字化服务</b><br><br>除了网站和小程序开发，我们还提供：<br><br>🤖 <b>AI 客服搭建</b> — ¥2,800起<br>　为网站/小程序/公众号接入智能客服，24/7自动应答<br><br>⚡ <b>全自动化工作流搭建</b> — ¥3,800起<br>　基于n8n/Make平台，自动化你的业务流程<br><br>📞 电话：' + AI_KB.company.tel + '<br>💬 微信：' + AI_KB.company.wx + '<br><br>👉 想详细了解哪个服务？';
  }
...
var FALLBACK_PROJECTS = [
  { id: 1, title: '企业品牌官网案例', category: 'website', tags: ['企业', '品牌展示'], desc: '响应式企业官网，含服务展示、关于我们、联系表单等标准页面，支持CMS后台管理。', tech: ['响应式设计', 'CMS后台', 'SEO优化', '联系表单'] },
  { id: 2, title: '餐饮门店小程序案例', category: 'miniapp', tags: ['餐饮', '小程序'], desc: '扫码点餐+会员系统微信小程序，支持堂食和外卖模式，实时订单管理。', tech: ['微信小程序', '云开发', '微信支付', '实时订单'] },
  { id: 3, title: '品牌电商商城案例', category: 'ecommerce', tags: ['电商', '零售'], desc: '品牌电商独立站/小程序，商品管理+购物车+在线支付+订单管理完整流程。', tech: ['电商系统', '微信支付', '会员积分', '数据看板'] },
  { id: 4, title: '服务预约平台案例', category: 'service', tags: ['预约', '服务行业'], desc: '在线预约系统，支持服务展示、时段预约、自动提醒、评价反馈等功能。', tech: ['预约系统', '消息推送', 'CRM对接', '数据统计'] },
  { id: 5, title: 'AI客服部署案例', category: 'service', tags: ['AI', '企业服务'], desc: '为已有网站/小程序接入AI智能客服，知识库训练+多轮对话+数据分析面板。', tech: ['AI客服', '知识库训练', '多端嵌入', '数据分析'] },
  { id: 6, title: '自动化工作流案例', category: 'service', tags: ['自动化', '企业服务'], desc: '基于n8n平台的企业工作流自动化：表单录入→通知→数据入库→报表生成全链路。', tech: ['n8n工作流', 'API对接', '企微/飞书通知', '数据库'] }
];
...
function getCategoryLabel(cat) {
  var map = { website: '网站开发', miniapp: '小程序', ecommerce: '电商', service: '企业服务' };
  return map[cat] || cat;
}

function getCategoryIcon(cat) {
  var map = { website: 'globe', miniapp: 'mobile-alt', ecommerce: 'shopping-cart', service: 'briefcase' };
